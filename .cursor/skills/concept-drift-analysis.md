...
**Mode**: `AUTO`
**Canonical source**: `.windsurf/skills/concept-drift-analysis/SKILL.md`

Read `.windsurf/skills/concept-drift-analysis/SKILL.md` in full before invoking this skill. The canonical
