...
```bash
copier copy --vcs-ref=v0.23.0 https://github.com/DuqueOM/ML-MLOps-Production-Template.git my_service
cd my_service
```
...
> alongside the active `v0.x` line. `v1.12.0` sorts above `v0.23.0`, so the
