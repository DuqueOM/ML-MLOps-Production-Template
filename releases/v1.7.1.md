...
- Typed agent handoffs (`AgentContext`, frozen dataclasses) (closed in v1.8.0).
- Automated `rule-audit` skill scanning for D-01..D-27 compliance (closed in v1.8.0).
- API contracts rule (OpenAPI + Pydantic parity) (closed in v1.8.0).
- Pod Security Standards baseline + SBOM attestation + ThreadPool sizing (closed in v1.8.1).
- Intersectional fairness auditing (closed in v1.8.1).
