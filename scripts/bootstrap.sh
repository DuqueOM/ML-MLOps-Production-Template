...
echo ""
echo "  4. Protect main + tags on your GitHub fork (one-time, CONSULT-class):"
echo -e "     ${YELLOW}make setup-github            ${NC}# preview + apply 2 rulesets"
echo -e "     ${YELLOW}make setup-github-check      ${NC}# verify rulesets are active"
echo "     See: docs/decisions/ADR-026-branch-protection.md"
echo ""
