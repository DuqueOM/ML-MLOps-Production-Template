...
**Mode**: `AUTO`
**Canonical source**: `.windsurf/skills/batch-inference/SKILL.md`

Read `.windsurf/skills/batch-inference/SKILL.md` in full before invoking this skill. The canonical
