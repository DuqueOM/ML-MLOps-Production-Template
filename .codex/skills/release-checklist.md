...
**Mode**: `CONSULT`
**Canonical source**: `.windsurf/skills/release-checklist/SKILL.md`

Read `.windsurf/skills/release-checklist/SKILL.md` in full before invoking this skill. The canonical
